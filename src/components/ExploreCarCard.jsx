...
const ExploreCarCard = ({ cars }) => {
    ...
    return (
        <section className="w-full">
            ...
            {/* Empty State */}
            {cars.length === 0 && (
                <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 py-20 text-center">
                    <FaCarSide size={40} className="mb-4 text-gray-300" />
                    <p className="text-lg font-semibold text-gray-500 dark:text-gray-300">No cars found</p>
                    <p className="mt-1 text-sm text-gray-400 dark:text-gray-500">Try adjusting your search or filters.</p>
                    <button
                        onClick={() => router.push(pathname)}
            ...
            {cars.length > 0 && (
                <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                    {cars.map((car) => (
                        <article
                            key={car._id}
                            className="group flex h-full flex-col overflow-hidden rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl dark:hover:shadow-gray-950/50"
                        >
                            {/* Image */}
                            <div className="relative h-52 overflow-hidden bg-gray-100 dark:bg-gray-700">
                                ...
                                <span className="absolute bottom-3 right-3 rounded-lg bg-white/95 dark:bg-slate-900/95 border border-gray-100/50 dark:border-gray-700/50 px-3 py-1 text-sm font-extrabold text-green-800 dark:text-green-400 shadow">
                                    ${car.dailyRentPrice}
                            ...
                            <div className="flex grow flex-col p-5">
                                ...
                                <div className="flex items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <span className="mt-1.5 inline-flex items-center gap-1.5 rounded-full bg-green-50 dark:bg-green-900 px-2.5 py-0.5 text-xs font-semibold text-green-700 dark:text-green-300 ring-1 ring-green-200 dark:ring-green-800">
                                            <FaCarSide size={10} />
                                            {car.carType}
                                        </span>
                                    </div>
                                ...
                                <div className="mt-4 grid grid-cols-2 gap-2.5 text-sm">
                                    <div className="flex items-center gap-2 rounded-xl bg-gray-50 dark:bg-gray-700 px-3 py-2.5">
                                        <FaUsers className="shrink-0 text-green-500" size={13} />
                                        <div>
                                            <p className="font-semibold text-gray-800 dark:text-white">{car.seatCapacity} seats</p>
                                    ...
                                    <div className="flex items-center gap-2 rounded-xl bg-gray-50 dark:bg-gray-700 px-3 py-2.5">
                                        ...
                                        <div>
                                            <p className="line-clamp-1 font-semibold text-gray-800 dark:text-white">{car.pickupLocation}</p>
                                ...
                                {/* Description */}
                                <p className="mt-4 line-clamp-2 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                    {car.description}
                                </p>
